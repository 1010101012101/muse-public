        ...
        while 1:
            ...
            if sBuildTarget:
                ...
                if "_8tof" in dBuildTarget['projectPath']:
                    ...
                    sBuildPath = os.path.join('/data/builder_SAN/outputCyber', sProjectPath)
...
def main(argv):
    ...
    options, remainder = getopt.getopt(sys.argv[1:], 'f:o:rdy', ['forks=','os=','rebuild','debug','debug-flags'])
