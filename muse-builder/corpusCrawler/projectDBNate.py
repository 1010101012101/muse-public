    ...
    def insertIntoBuildStatusTargets(self, dArgs, bDebug=False):
        ...
        if bMissingArg:
            ...
            for dTarget in dArgs['targets']:
                ...
                sQuery += 'buildTargetPath,'
                sQuery += 'buildTarPath,'
                # Add back in after insert into Mysql
                ...
                tArgs = (dArgs['projectName'], dArgs['projectPath'], self.verifyEncoding(dTarget['buildTargetPath']), dArgs['buildTarPath'], dArgs['version'], dArgs['os'], str(dTarget['returnCode']))
