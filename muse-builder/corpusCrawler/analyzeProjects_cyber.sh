...
#python queueProjects_cyber.py --analyze-projects --cyber-projects-file=cyberPhysicalAll.txt >$logPath/queueAnalyzeProjectsToBuildByType_$today.out 2>$logPath/queueAnalyzeProjectsToBuildByType_$today.err

python queueProjects_cyber.py --analyze-projects --cyber-projects-file=/home/muse/corpusRAT.txt >$logPath/queueAnalyzeProjectsToBuildByType_$today.out 2>$logPath/queueAnalyzeProjectsToBuildByType_$today.err
